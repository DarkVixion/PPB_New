...
public class OrderFotoUtil {
    ...
    private static List<com.example.modul2.OrderFoto> orderFotoList;
    ...
    public static com.example.modul2.OrderFoto getOrderAt(int i){
        return orderFotoList.get(i);
    }

    private static void updateKeranjangBelanja(){
        totalHarga = 0.0;
        for (com.example.modul2.OrderFoto order:orderFotoList){
    ...
    public static void addOrder(KatalogFoto foto, String ukuran){
        orderFotoList.add(new com.example.modul2.OrderFoto(foto, 1, ukuran, getHarga(ukuran)));
    ...
    public static void addOneToOrder(int i){
        com.example.modul2.OrderFoto order = orderFotoList.get(i);
